...
func CreateDockerBridge(name string, image string, playground string) (string, string, string, string, string, error) {
	...
	var cid = ""
	cid, ip, err = docker.RunCustomContainer(ctx, "playground-"+name, image, "bg-"+name, playground)
	if err != nil {
